...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/new/main/File_Bot/commands.lua") 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'سوريا'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
send(msg.chat_id_, msg.id_,' ✹ اصدار سورس سوريا{ 3x✴}')
end
...
local Text = [[ 
[قناه سورس سوريا ادخل وتابع الجديد](t.me/X_G_33)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'عموري' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'X_G_33')..') \n ◉ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/X_G_33)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/new/main/library')
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/new/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
╭𖤍━┅⟞⟦[᪣𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼᪣](http://t.me/X_G_33)⟧⟝┉━𖤍╮

 [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝙎𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼⟧](http://t.me/X_G_33)
...
{{text = '𝘈𝘏𝘔𝘌𝘋 𝘊𝘙𝘌𝘡𝘡𝘠  ',url="t.me/siria100"}},
...
local Text = [[  
قلبــــــــيــــــــے الطــــــــيــــــــبــــــــ بــــــــق ڊبــــــــاحــــــــ 😉❤️⭐️
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'ᯓ 𓌹🖤🦇 علي مهلكك كدا كدا شفاف هتجهلك 𓌺',url="t.me/A_S_K_N_D_R_A_N_Y69"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/A_S_K_N_D_R_A_N_Y69&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧مطـور السورس✧',url="t.me/Dv_alsahel1"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dv_alsahel1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/X_G_33)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'X_G_33')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'X_G_33')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'X_G_33')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if result.id_ == tonumber(1364212456) then
...
if tonumber(userid) == tonumber(1364212456) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if text == ("مسح قائمه سوريا") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه سوريا')
return false
end

if text == 'قائمه سوريا' and Sudo(msg) then
...
if text == ("رفع سوريا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local X_G_33 = database:get(bot_id..'text:ch:user')
if X_G_33 then
send(msg.chat_id_, msg.id_,'['..X_G_33..']')
...
if text and text:match("^رفع سوريا @(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع سوريا (%d+)$") and Sudo(msg) then
...
if text == ("تنزيل سوريا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local X_G_33 = database:get(bot_id..'text:ch:user')
if X_G_33 then
send(msg.chat_id_, msg.id_,'['..X_G_33..']')
...
if text and text:match("^تنزيل سوريا @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سوريا @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local X_G_33 = database:get(bot_id..'text:ch:user')
if X_G_33 then
send(msg.chat_id_, msg.id_,'['..X_G_33..']')
...
if text and text:match("^تنزيل سوريا (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سوريا (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local X_G_33 = database:get(bot_id..'text:ch:user')
if X_G_33 then
send(msg.chat_id_, msg.id_,'['..X_G_33..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'X_G_33')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'X_G_33')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."X_G_33:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."X_G_33:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."X_G_33:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه سوريا') 
return false
end
...
if not database:sismember(bot_id..'DRAGON:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."DRAGON:Spam:Group"..msg.sender_user_id_,text) 
...
local Add_Mem = database:get(bot_id.."DRAGON:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."DRAGON:Klesh:Id:Bot"..msg.chat_id_) or database:get(bot_id.."DRAGON:KleshIDALLBOT")
if not database:get(bot_id..'DRAGON:Lock:ID:Bot:Photo'..msg.chat_id_) then
if taha.photos_[0] then
if get_id then
...
local NumMsg = database:get(bot_id..'DRAGON:messageUser'..data.chat_id_..':'..data.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."DRAGON:Comd:New:rt:User:"..data.chat_id_..Id) or Get_Rank(Id,data.chat_id_)
local message_edit = database:get(bot_id..'DRAGON:message_edit'..data.chat_id_..data.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."DRAGON:Add:Num"..data.chat_id_..data.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."DRAGON:Add:Memp"..data.chat_id_..":"..data.sender_user_id_) or 0
local Total_Photp = (taha.total_count_ or 0)
local Texting = {
'طالع ححلو الوصخ 😂😔💘',
"بشر لو كيك نتهه😹💘 ",
